 ...
 *
 * Description:
 * Defines the rwlock external interfaces wrapper for POSIX standard rwlock.
 *
 * ---------------------------------------------------------------------------------
 */
#ifndef UTILS_POSIX_RWLOCK_H
#define UTILS_POSIX_RWLOCK_H
...
struct RWLock {
    pthread_rwlock_t rwlock; /* rwlock controlling the lock */
};
