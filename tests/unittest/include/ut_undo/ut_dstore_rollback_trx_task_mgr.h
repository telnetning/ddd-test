 ...
 */
#ifndef UT_DSTORE_ROLLBACK_TRX_TASK_MGR_H
#define UT_DSTORE_ROLLBACK_TRX_TASK_MGR_H
...
class UTRollbackTrxTaskMgr : public DSTORETEST {
protected:
    void SetUp() override
    {
        DSTORETEST::SetUp();
...
#endif  /* UT_STORAGE_ROLLBACK_TRX_TASK_MGR_H */